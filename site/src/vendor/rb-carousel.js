// ─────────────────────────────────────────────────────────────────────────
// VENDORED from https://github.com/LucDesautels/Portfolio-Scripts-v2
//   file:      rb-carousel.js  (v1.7.0)
//   fetched:   2026-08-28
//   was:       loaded at runtime from
//              https://cdn.jsdelivr.net/gh/LucDesautels/Portfolio-Scripts-v2@main/rb-carousel.js
//
// Copied in so the project owns this code outright and never depends on
// jsDelivr or that repo staying up. Unmodified below this header.
//
// STATUS: not loaded by any page right now, and it is NOT the drone-gallery
// scroll plugin. It is the robotics section carousel + lightbox: init() bails
// immediately unless it finds "section.rb", and it binds to .rb-row, .rb-col,
// .rb-prog and .rb-lb-* markup that this site does not have. The drone page's
// two-zone snap scroll was always inline page code in the Webflow export, and
// lives in src/pages/drone-videography.astro.
//
// The equivalent behaviour on this site is already native: see
// SubprojectsCarousel.astro, RoboticsPanels.astro and the EngPrograms
// lightbox. Kept here as the archived original in case that Webflow robotics
// section is ever ported across.
// ─────────────────────────────────────────────────────────────────────────
/* =========================================================================
